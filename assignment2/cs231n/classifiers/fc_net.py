...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for count,hidden_dim in hidden_dims:
          self.params['W'+str(count)] = np.random.normal(scale=weight_scale, size=(input_dim, hidden_dims))
          self.params['W2'] = np.random.normal(scale=weight_scale, size=(hidden_dims, num_classes))
